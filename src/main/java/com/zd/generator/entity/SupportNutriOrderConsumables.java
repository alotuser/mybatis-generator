 ...
 * @since 2021-12-07
 */
@TableName("support_nutri_order_consumables")
@ApiModel(value = "SupportNutriOrderConsumables对象", description = "营养医嘱耗材明细表")
public class SupportNutriOrderConsumables extends BaseModel {

    private static final long serialVersionUID = 1L;

    @TableId(value = "noc_id", type = IdType.AUTO)
    private Long nocId;
    ...
    public String toString() {
        return "SupportNutriOrderConsumables{" +
            "nocId=" + nocId +
            ", noId=" + noId +
            ", patientId=" + patientId +
            ", visitId=" + visitId +
