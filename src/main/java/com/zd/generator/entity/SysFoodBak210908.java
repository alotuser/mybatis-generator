 ...
 * @since 2021-12-07
 */
@TableName("sys_food_bak_210908")
@ApiModel(value = "SysFoodBak210908对象", description = "食物成分表")
public class SysFoodBak210908 extends BaseModel {
