 ...
 * @since 2021-12-07
 */
@TableName("visit_user_menu_detail")
@ApiModel(value = "VisitUserMenuDetail对象", description = "用户菜谱明细表")
public class VisitUserMenuDetail extends BaseModel {
